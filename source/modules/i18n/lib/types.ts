...
/**
 * Represents the timezone for a user.
 * It can be either the user's local timezone or a specific timezone.
 */
export type UserTimezone = "user" | Timezone;

/**
 * Union of recognized timezones.
 * @see https://github.com/prantlf/timezone-support/blob/master/util/data/meta.json
 */
